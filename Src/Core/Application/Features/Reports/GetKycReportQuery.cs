...
{
    public class GetKycReportQuery : IRequest<ApiResponse<PagedResult<KycDto>>>
    {
    ...
    public class GetKycReportQueryHandler : IRequestHandler<GetKycReportQuery, ApiResponse<PagedResult<KycDto>>>
    {
        private readonly IApplicationDbContext _context;

        public GetKycReportQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<ApiResponse<PagedResult<KycDto>>> Handle(GetKycReportQuery request, CancellationToken cancellationToken)
        {
